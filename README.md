...
Inspect the page to identify which elements to scrape. Hint: To identify which elements to scrape, you might want to inspect the page by using Chrome DevTools.
